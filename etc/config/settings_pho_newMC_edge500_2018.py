...
baseOutDir = 'results/Data2018/tnpPhoID_newMC_edge500/'
...
tnpParNomFit = [
    ...
    "acmsP[60.,50.,80.]","betaP[0.05,0.01,0.08]","gammaP[0.1, 0.005, 1]","peakP[90.0]",
...
tnpParAltSigFit = [
    ...
    "acmsP[60.,50.,90.]","betaP[0.05,0.01,0.08]","gammaP[0.1, 0.005, 1]","peakP[90.0]",
    "acmsF[60.,50.,90.]","betaF[0.05,0.01,0.08]","gammaF[0.1, -2, 2]","peakF[90.0]",
    ]
     
tnpParAltBkgFit = [
    "meanP[-0.0,-5.0,5.0]","sigmaP[0.9,0.5,5.0]",
    "meanF[1.0,-5.0,5.0]","sigmaF[1.2,0.5,3.0]",
    "alphaP[0.,-5.,5.]",
    "alphaF[0.02,-5.,5.]",
    ]
