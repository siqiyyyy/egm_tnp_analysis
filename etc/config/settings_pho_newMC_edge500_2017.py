...
baseOutDir = 'results/Data2017/tnpPhoID_newMC_edge500/'
...
tnpParAltSigFit = [
    "meanP[-0.0,-5.0,5.0]","sigmaP[0.9,0.5,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[1,0.5,5.0]",
    "meanF[-0.0,-5.0,5.0]","sigmaF[2,0.7,15.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[1,0.5,5.0]",
    "acmsP[60.,50.,75.]","betaP[0.04,0.01,0.18]","gammaP[0.1, 0.001, 1]","peakP[90.0]",
